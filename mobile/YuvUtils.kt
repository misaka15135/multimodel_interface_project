...
object YuvUtils {
    // Convert ImageProxy (YUV_420_888) to Bitmap using NV21 -> YuvImage -> JPEG
    fun imageProxyToBitmap(image: ImageProxy): Bitmap? {
        val imageFormat = image.format
        if (imageFormat != ImageFormat.YUV_420_888) return null
        ...
        return try {
            ...
            // Rotate according to image rotationDegrees
        ...
        try {
            ...
            for (row in 0 until chromaHeight) {
                ...
                for (col in 0 until width step 2) {
                    // column index for chroma is col/2
                    val chromaCol = col / 2
