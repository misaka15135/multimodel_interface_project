...
(function () {
  ...
  function runSmokeTest() {
    ...
    setTimeout(function () {
      dispatchRequest('click-target');
      log('requested isolated voice click_target probe');
    }, 550);
    setTimeout(function () {
  ...
  function buildUI() {
    ...
    root.innerHTML = [
      ...
      '    <button type="button" data-action="click">语音侧点击</button>',
