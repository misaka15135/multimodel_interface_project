...
// ============================================================
//  GestureAdapter — 手势模块 → MMFusion 适配桥  (v0.4)
// ============================================================
...
(function () {
  ...
  // ----------------------------------------------------------
  //  手势同学需要做的「一行接入」示例（粘到你现有代码里即可）：
  //
  //  1) 手势确认触发处（如 executeAction 内 / handleContinuous 的 onConfirm）：
  //        window.__mmPublishGesture("PALM_UP");
  //
  //  2) 自由模式光标移动处（handleFreeModeCursor 里，用你已算好的视口坐标）：
  //        window.__mmPublishPointer(smoothedCursorX, smoothedCursorY);
  //
  //  完成后：语音说"向下滚动"会与手势 PALM_DOWN 在 500ms 内自动去重；
  //          语音说"点这个"会点击你光标指向的元素。
  // ----------------------------------------------------------
})();
