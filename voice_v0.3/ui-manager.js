      ...
      container.innerHTML = `
        ...
        <div id="voice-ext-settings">
          ...
          <div class="settings-row">
            <span>语音反馈 (TTS)</span>
            <button id="voice-ext-tts-toggle" class="settings-toggle on" title="开关语音播报"></button>
          </div>
          <div class="settings-row">
            <span>唤醒词模式</span>
            <button id="voice-ext-wake-toggle" class="settings-toggle on" title="说"小助手"激活"></button>
          </div>
          <div class="btn-row">
